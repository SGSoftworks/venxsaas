-- ============================================================================
-- VenxPOS SaaS — Fix: ambigüedad en get_low_stock_products
-- Renombra alias inv.stock_actual a inv.stk_actual para evitar conflicto
-- con RETURN TABLE stock_actual
-- ============================================================================
