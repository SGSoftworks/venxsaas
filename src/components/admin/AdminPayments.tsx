      ...
      try {
        ...
        const rows = (data || []).map((d: Record<string, unknown>) => {
          ...
          return {
            ...
            wompi_reference: d.wompi_reference as string | null,
                          ...
                          {techDetailsOpen[p.id] && (
                            <div className="grid grid-cols-2 gap-4 mt-2 text-[11px]">
                              <div>
                                ...
                                <p className="text-slate-500 font-mono break-all">{p.wompi_transaction_id || '\u2014'}</p>
                              </div>
                              <div>
                                <p className="text-slate-400 mb-0.5">Referencia</p>
                                <p className="text-slate-500 font-mono break-all">{p.wompi_reference || '\u2014'}</p>
                              </div>
                            </div>
                          )}
                        </div>
